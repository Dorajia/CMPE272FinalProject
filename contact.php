...
<html lang="en">
  <head>
    ...
    <link href="bootstrap/custom/jumbotron.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette" style="background-color:white">
        <div class="col-md-7">
          <h2 class="featurette-heading">Project SF Transit Time <span class="text-muted"></span></h2>
          <p class="lead">Commuter in San Francisco have some of the worst commutes in the San Francisco. Our project illustrates just how bad it can get...</p>
        </div>
      </div>
    ...
    <div class="row featurette">
      ...
      <footer>
        ...
        <p>&copy; 2015 Project SF Transit Time &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
    </div>
